...
//        new BufferedImage()
        ...
        try (
            FileImageOutputStream fileOut = new FileImageOutputStream(new File("/Users/zhanglifeng/img2.png"))) {
            BufferedImage inImage = ImageIO.read(new File("/Users/zhanglifeng/IdeaProjects/lifo/lifo-shopify-service/lifo-mail-service/src/main/resources/img1.png"));
            BufferedImage outImage = grayImage(inImage);
            boolean write = ImageIO.write(outImage, "img2.png", fileOut);
